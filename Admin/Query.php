...
<body>
    <center>
       <div class="header">
            ...
            <div><a href="#" id="Active">Queries</a></div>
   ...
   <?php
    ...
    ?>
        ...
        <div class="producttabs" style="width:95%; padding-top:10px; padding-bottom:10px; background:#fff; margin-top:20px;">
            ...
            <h2 style="color:#1a1a1a; text-align:left; padding-left:20px; padding-right:20px;"><?php echo $result->Subject; ?></h2><br>
            
            <p style=" font-size:17px;color:#1a1a1a; text-align:left; padding-left:20px; padding-right:20px;"><?php echo $res->QuestionBody; ?></p>
