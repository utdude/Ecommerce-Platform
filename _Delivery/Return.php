    ...
    <div class="container">
     ...
     ?>
        ...
        <center>
            ...
            <button class="simple dark" type="submit" id="Shipped" style="width:150px;">Picked Up</button>
            <h3 style="color:#00ff7f; padding:15px; line-height:25px; letter-spacing:1px;" id="success"></h3>
            <button class="simple dark" type="submit" id="Delivered" style="width:150px;">Returned</button>
             ...
             var OrderID = "<?php echo $result->OrderID; ?>";
               $.ajax({
                  url:"../Process/Shipped.php" ,
                    type:"POST",
                   data:{pickup:'pickup',ReturnorderID:OrderID},
                   success:function(data){
                      if(jQuery.trim(data) == ""){
                          ...
                          $('#success').html("The Item Has Been Picked Up!");
